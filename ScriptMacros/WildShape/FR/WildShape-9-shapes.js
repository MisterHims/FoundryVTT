...
let d = new Dialog({
    ...
    content: `
     ...
     <div class="form-group">
         ...
         <option value="shape-4">Forme 4</option>
         <option value="shape-5">Forme 5</option>
         <option value="shape-6">Forme 6</option>
         <option value="shape-7">Forme 7</option>
         <option value="shape-8">Forme 8</option>
         <option value="shape-9">Forme 9</option>
         </select>
     </div>
     </form>
     `,
